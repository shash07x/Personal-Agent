...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "close the assistant, say goodbye, or stop Poison. "
...
class PoisonLive:
    ...
    async def _receive_audio(self):
        ...
        if session is None or audio_in_queue is None:
            return
                ...
                async for response in session.receive():
                    ...
                    if response.server_content:
                        ...
                        if sc.turn_complete:
                            ...
                            if full_out:
                                self.ui.write_log(f"Poison: {full_out}")
                            out_buf = []
...
def main():
    ...
    def runner():
        ui.wait_for_api_key()
        poison = PoisonLive(ui)
        try:
            asyncio.run(poison.run())
